...
The hints came from the `fm-test-timing-portable-serial-*` artifacts of green CI run [33394627372](https://github.com/BenWilcox8/firstmate/actions/runs/33394627372) on 2026-08-31, where the lane ran 146 scripts in 3587346 ms of serial work.
...
| Lane | Script count | Estimated duration |
|---|---:|---:|
| `portable-serial-1of4` | 36 | 896845 ms (~896.8 s) |
| `portable-serial-2of4` | 37 | 896833 ms (~896.8 s) |
| `portable-serial-3of4` | 36 | 896831 ms (~896.8 s) |
| `portable-serial-4of4` | 37 | 896837 ms (~896.8 s) |
| imbalance | | 14 ms |

The single longest script, `tests/fm-watch-triage.test.sh` at 292620 ms, is the floor for any shard count.
