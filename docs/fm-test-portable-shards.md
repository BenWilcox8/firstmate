...
The hints came from the `fm-test-timing-portable-serial-*` artifacts of green CI run [33394627372](https://github.com/BenWilcox8/firstmate/actions/runs/33394627372) on 2026-08-31, updated with observed runtimes from CI run [33399507055](https://github.com/BenWilcox8/firstmate/actions/runs/33399507055) for scripts that ran significantly over their prior hint.
...
| Lane | Script count | Estimated duration |
|---|---:|---:|
| `portable-serial-1of5` | 29 | 776214 ms (~776.2 s) |
| `portable-serial-2of5` | 29 | 776206 ms (~776.2 s) |
| `portable-serial-3of5` | 30 | 776214 ms (~776.2 s) |
| `portable-serial-4of5` | 29 | 776209 ms (~776.2 s) |
| `portable-serial-5of5` | 29 | 776209 ms (~776.2 s) |
| imbalance | | 8 ms |

The single longest script, `tests/fm-watch-triage.test.sh` at 306000 ms, is the floor for any shard count.
...
| portable serial 1-5 | job `timeout-minutes: 20` | Each balanced shard is about thirteen minutes of measured script time, leaving roughly 1.5x hang-tripwire margin for job setup and runner-speed spread. |
