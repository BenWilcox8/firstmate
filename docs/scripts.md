...
| `fm-atlas-hook.sh`       | Record an Atlas ticket lifecycle fact at spawn, merge, and teardown; answer `wired` queries that report whether this home has an Atlas pointer |
