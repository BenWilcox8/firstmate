...
Other routine outcomes return as appended notes that lead with ⛵ then the dim outcome text, and their rendering follows the [routine supervision notes preference](../configuration.md#routine-supervision-notes-preference-configroutine-supervision-notes).
