...
Upstream observations from 2026-09-10 on Herdr 0.9.0 follow.
They predate this fork's stricter process-ownership checks and do not verify the reconciled implementation.
