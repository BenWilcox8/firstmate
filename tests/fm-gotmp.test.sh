...
SH
  ...
  # fm-atlas-word-lib.sh: teardown parses its optional captain-word argument through it.
  ln -s "$ROOT/bin/fm-atlas-word-lib.sh" "$fake/bin/fm-atlas-word-lib.sh"
  ...
  # requires the operational-input owner even for this ordinary-task teardown fixture.
