...
# PR-based delivery requires a non-draft PR, read back from the forge.
# A deliberately held draft requires a paused wait.
# Preserve actual requirement text without adding speaker labels or direct address.
