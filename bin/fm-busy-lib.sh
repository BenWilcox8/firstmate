...
# Grok, AGY, and historical Rovo records use rendered-text classifications.
# Their structured lifecycles lack verified busy-state integration.
# AGY 1.2.0 exposes no hook surface; see references/harness/agy.md.
# Each classifier is scoped to its own harness and cannot classify another
# adapter. Rovo dispatch remains disabled. The delivery
