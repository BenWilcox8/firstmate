...
6. Preserve all accepted requirements and exclusions from the original Task, including the Firstmate spec and unmarked legacy text. Apply later explicit supersessions. Replace investigation-only procedures with these ship instructions.
