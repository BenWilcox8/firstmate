...
tests/fm-backend-cmux.test.sh 3687
...
tests/fm-backlog-atomicity.test.sh 154677
...
tests/fm-bootstrap-network-parallel.test.sh 9305
tests/fm-bootstrap.test.sh 26417
tests/fm-branch-supervision.test.sh 8757
tests/fm-browser-reap.test.sh 12828
tests/fm-busy-adapter-wiring.test.sh 26861
tests/fm-busy-state.test.sh 2956
tests/fm-calm-pi-extension.test.sh 51551
...
tests/fm-claude-stop-autoarm-live-e2e.test.sh 43
tests/fm-claude-stop-autoarm.test.sh 213113
tests/fm-claude-trust.test.sh 5795
tests/fm-cmux-claude-composer-live-e2e.test.sh 100
tests/fm-codex-continuity-live-e2e.test.sh 43
tests/fm-composer-matrix-live-e2e.test.sh 120
tests/fm-control-relaunch.test.sh 51515
tests/fm-control.test.sh 53613
tests/fm-cswap.test.sh 1274
...
tests/fm-gemini-harness.test.sh 584
tests/fm-gitignore-config.test.sh 62
tests/fm-gotmp.test.sh 1322
...
tests/fm-home-summary-refresh.test.sh 36924
tests/fm-inactive-reconcile.test.sh 73823
tests/fm-kimi-harness.test.sh 18630
tests/fm-lint-workflows.test.sh 855
tests/fm-live-gate.test.sh 6000
tests/fm-merge-local.test.sh 1951
...
tests/fm-omp-harness.test.sh 47126
tests/fm-omp-primary-live-e2e.test.sh 100
tests/fm-on.test.sh 11692
tests/fm-opencode-primary-live-e2e.test.sh 44
...
tests/fm-quota-choose.test.sh 1481
...
tests/fm-rovo-harness.test.sh 31594
tests/fm-rovo-signals-live-e2e.test.sh 45
...
tests/fm-secondmate-reconcile.test.sh 97279
tests/fm-secondmate-registry-lib.test.sh 53
tests/fm-secondmate-restart.test.sh 103394
tests/fm-secondmate-safety.test.sh 58047
...
tests/fm-send-inbox.test.sh 39226
tests/fm-send-remote-delivery.test.sh 27686
tests/fm-send-resolve-key.test.sh 27776
...
tests/fm-sessionstart-hook-live-e2e.test.sh 56
...
tests/fm-spawn-claude-persistence.test.sh 21307
tests/fm-spawn-dispatch-profile.test.sh 124945
tests/fm-spawn-pool-base-freshen.test.sh 62834
tests/fm-spawn-session-name.test.sh 21726
tests/fm-spawn-ticket-warning.test.sh 11486
tests/fm-spawn-worktree-settle.test.sh 8223
tests/fm-startup-memory-budget.test.sh 7023
