...
family_for_basename() {
  ...
  case "$1" in
    ...
    fm-brief.test.sh|fm-brief-merge-contract.test.sh|fm-captain-archive-bound.test.sh|fm-vendor-auth-probe.test.sh|\
    ...
    fm-herdr-submit-confirm-live-e2e.test.sh|fm-agent-count-live-e2e.test.sh)
      printf '%s\n' live-harness-optin
      ;;
    fm-backend-herdr.test.sh|fm-backend-herdr-recovery-state.test.sh|fm-herdr-merge-harnesses.test.sh|\
