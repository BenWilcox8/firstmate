...
tests/fm-backend-cmux.test.sh 3727
tests/fm-backend-herdr-codex-submit-e2e.test.sh 66
tests/fm-backend-herdr-native-recovery.test.sh 229
tests/fm-backend-herdr-recovery-state.test.sh 2733
...
tests/fm-bearings-snapshot.test.sh 109802
tests/fm-bootstrap-network-parallel.test.sh 9773
tests/fm-bootstrap.test.sh 27286
...
tests/fm-claude-stop-autoarm.test.sh 213113
...
tests/fm-extension-binding.test.sh 8548
...
tests/fm-kimi-harness.test.sh 18717
...
tests/fm-pi-watch-extension.test.sh 51797
...
tests/fm-procevent-when.test.sh 18226
...
tests/fm-remote-job-orphan-reap.test.sh 3018
...
tests/fm-startup-memory-budget.test.sh 7206
...
tests/fm-teardown-endpoint-safety.test.sh 31793
...
tests/fm-vendor-auth-probe.test.sh 45886
