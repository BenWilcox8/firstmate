...
tests/fm-afk-return.test.sh 1845
...
tests/fm-backend-herdr-codex-submit-e2e.test.sh 93
...
tests/fm-backend-zellij.test.sh 10091
tests/fm-backend.test.sh 38815
tests/fm-backlog-atomicity.test.sh 155903
...
tests/fm-bearings-board.test.sh 34882
tests/fm-bearings-snapshot.test.sh 115043
tests/fm-bootstrap-network-parallel.test.sh 9773
tests/fm-bootstrap.test.sh 67954
tests/fm-branch-supervision.test.sh 8987
tests/fm-browser-reap.test.sh 13228
tests/fm-busy-adapter-wiring.test.sh 47265
tests/fm-busy-state.test.sh 2956
...
tests/fm-claude-trust.test.sh 5802
tests/fm-cmux-claude-composer-live-e2e.test.sh 100
tests/fm-codex-continuity-live-e2e.test.sh 65
...
tests/fm-gemini-harness.test.sh 607
tests/fm-gitignore-config.test.sh 62
tests/fm-gotmp.test.sh 1389
...
tests/fm-herdr-version-floor-live-e2e.test.sh 70
...
tests/fm-omp-harness.test.sh 47197
...
tests/fm-remote-job.test.sh 60012
...
tests/fm-send-busy-doorbell.test.sh 7819
...
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 72
...
tests/fm-sessionstart-instruction-refresh-live-e2e.test.sh 98
...
tests/fm-wake-daemon-lifecycle-e2e.test.sh 7806
...
tests/fm-wake-drain.test.sh 2714
tests/fm-wake-queue.test.sh 79578
tests/fm-watch-arm.test.sh 64427
tests/fm-watch-checkpoint.test.sh 5895
