...
family_for_basename() {
  case "$1" in
    ...
    fm-test-run.test.sh|fm-test-isolation-proof.test.sh)
      printf '%s\n' pure-contract-unit
      ;;
    fm-daemon-codex-short-wake.test.sh|fm-daemon.test.sh|fm-guard-stale-banner.test.sh|fm-pi-watch-extension.test.sh|\
    ...
    fm-herdr-submit-confirm-live-e2e.test.sh|fm-agent-count-live-e2e.test.sh)
      printf '%s\n' live-harness-optin
      ;;
...
# artifacts and isolated checks recorded in docs/fm-test-portable-shards.md.
# Retain the slowest successful script observation and each larger existing
# hint. These are balance hints only: the shard
...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-action-pins-check.test.sh 437
tests/fm-afk-inject-e2e.test.sh 35792
tests/fm-afk-pi-herdr-return-e2e.test.sh 100
tests/fm-afk-return.test.sh 1879
tests/fm-agentsmd-ceiling.test.sh 613
tests/fm-agentsmd-skill-triggers.test.sh 259
tests/fm-ask-user-authority.test.sh 231
tests/fm-atlas-hook.test.sh 54906
tests/fm-backend-cmux-smoke.test.sh 35
tests/fm-backend-cmux.test.sh 4170
tests/fm-backend-herdr-codex-submit-e2e.test.sh 100
tests/fm-backend-herdr-native-recovery.test.sh 229
tests/fm-backend-herdr-recovery-state.test.sh 6155
tests/fm-backend-orca.test.sh 38124
tests/fm-backend-tmux-smoke.test.sh 393
tests/fm-backend-zellij-smoke.test.sh 23
tests/fm-backend-zellij.test.sh 10273
tests/fm-backend.test.sh 38815
tests/fm-backlog-atomicity.test.sh 159272
tests/fm-backlog-handoff.test.sh 52291
tests/fm-bearings-board-lavish-live-e2e.test.sh 153
tests/fm-bearings-board-render.test.sh 4936
tests/fm-bearings-board.test.sh 36880
tests/fm-bearings-snapshot.test.sh 115043
tests/fm-bootstrap-network-parallel.test.sh 9872
tests/fm-bootstrap.test.sh 67954
tests/fm-branch-supervision.test.sh 9584
tests/fm-browser-reap.test.sh 13228
tests/fm-busy-adapter-wiring.test.sh 47265
tests/fm-busy-state.test.sh 3013
tests/fm-calm-pi-extension.test.sh 77099
tests/fm-check-unregister.test.sh 503
tests/fm-classify-corr-token.test.sh 38742
tests/fm-classify-decision-key.test.sh 1190
tests/fm-claude-stop-autoarm-live-e2e.test.sh 158
tests/fm-claude-stop-autoarm.test.sh 215900
tests/fm-claude-trust.test.sh 5994
tests/fm-cmux-claude-composer-live-e2e.test.sh 100
tests/fm-codex-continuity-live-e2e.test.sh 76
tests/fm-composer-matrix-live-e2e.test.sh 160
tests/fm-control-relaunch.test.sh 53705
tests/fm-control.test.sh 54190
tests/fm-cswap.test.sh 1390
tests/fm-cursor-harness.test.sh 30265
tests/fm-cursor-primary-live-e2e.test.sh 104
tests/fm-cursor-primary.test.sh 90640
tests/fm-daemon-codex-short-wake.test.sh 18105
tests/fm-daemon.test.sh 29846
tests/fm-documentation-audiences.test.sh 904
tests/fm-endpoint-retire.test.sh 28692
tests/fm-extension-binding.test.sh 21303
tests/fm-fleet-snapshot-home-summary-size.test.sh 25086
tests/fm-fleet-snapshot-view.test.sh 27551
tests/fm-fleet-sync.test.sh 38120
tests/fm-fleet-view.test.sh 650
tests/fm-gate-refuse.test.sh 5489
tests/fm-gemini-harness.test.sh 781
tests/fm-gitignore-config.test.sh 63
tests/fm-gotmp.test.sh 1400
tests/fm-grok-continuity-live-e2e.test.sh 118
tests/fm-grok-stop-live-e2e.test.sh 118
tests/fm-guard-stale-banner.test.sh 13952
tests/fm-harness-adapter-instructions-live-e2e.test.sh 97
tests/fm-harness-adapter-references.test.sh 171
tests/fm-harness-liveness-drift-live-e2e.test.sh 892
tests/fm-herdr-layout-lib.test.sh 653
tests/fm-herdr-session-cleanup.test.sh 18012
tests/fm-herdr-submit-confirm-live-e2e.test.sh 100
tests/fm-herdr-version-floor-live-e2e.test.sh 73
tests/fm-home-summary-refresh.test.sh 65132
tests/fm-inactive-reconcile.test.sh 73823
tests/fm-kimi-harness.test.sh 35856
tests/fm-lint-workflows.test.sh 855
tests/fm-live-gate.test.sh 6000
tests/fm-merge-local.test.sh 2226
tests/fm-muse-harness.test.sh 55572
tests/fm-muse-signals-live-e2e.test.sh 162
tests/fm-nm-test-contract.test.sh 1055
tests/fm-no-mistakes-required.test.sh 915
tests/fm-omp-harness.test.sh 47532
tests/fm-omp-primary-live-e2e.test.sh 100
tests/fm-on.test.sh 25554
tests/fm-opencode-primary-live-e2e.test.sh 95
tests/fm-operational-input.test.sh 252
tests/fm-peek-remote.test.sh 1207
tests/fm-pending-reply.test.sh 80547
tests/fm-pi-branch-extension.test.sh 62372
tests/fm-pi-branch-live-e2e.test.sh 103
tests/fm-pi-branch-responsiveness-live-e2e.test.sh 13137
tests/fm-pi-primary-live-e2e.test.sh 159
tests/fm-pi-watch-extension.test.sh 54383
tests/fm-pi-windows-shell-invocation.test.sh 5121
tests/fm-ping-ack.test.sh 4877
tests/fm-pr-check-security.test.sh 161184
tests/fm-procevent-quota.test.sh 2158
tests/fm-procevent-when.test.sh 18376
tests/fm-procevent.test.sh 81533
tests/fm-project-origin.test.sh 168
tests/fm-public-followup.test.sh 196745
tests/fm-quota-array-dispatch-live-e2e.test.sh 108
tests/fm-quota-choose.test.sh 1533
tests/fm-remote-backlog-handoff.test.sh 42027
tests/fm-remote-doctor.test.sh 5228
tests/fm-remote-entrypoint.test.sh 155
tests/fm-remote-job-orphan-reap.test.sh 4730
tests/fm-remote-job.test.sh 60090
tests/fm-remote-reply.test.sh 101690
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 232951
tests/fm-remote-secondmate-parent-binding.test.sh 34001
tests/fm-remote-secondmate-trace-context.test.sh 67096
tests/fm-remote-transport-lanes.test.sh 63235
tests/fm-rovo-harness.test.sh 58030
tests/fm-rovo-signals-live-e2e.test.sh 95
tests/fm-secondmate-harness.test.sh 162500
tests/fm-secondmate-lifecycle-e2e.test.sh 18671
tests/fm-secondmate-liveness.test.sh 18146
tests/fm-secondmate-reconcile.test.sh 97813
tests/fm-secondmate-registry-lib.test.sh 115
tests/fm-secondmate-restart.test.sh 103394
tests/fm-secondmate-safety.test.sh 149981
tests/fm-secondmate-sync.test.sh 90064
tests/fm-send-busy-doorbell.test.sh 7822
tests/fm-send-inbox-doorbell-live-e2e.test.sh 120
tests/fm-send-inbox.test.sh 54475
tests/fm-send-remote-delivery.test.sh 30230
tests/fm-send-resolve-key.test.sh 86693
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 79
tests/fm-send-secondmate-marker.test.sh 6424
tests/fm-session-lock-ancestry.test.sh 1458
tests/fm-session-start.test.sh 175043
tests/fm-sessionstart-hook-live-e2e.test.sh 78
tests/fm-sessionstart-instruction-refresh-live-e2e.test.sh 99
tests/fm-sessionstart-nudge.test.sh 66194
tests/fm-shared-captain-inheritance.test.sh 6301
tests/fm-spawn-claude-persistence.test.sh 37121
tests/fm-spawn-dispatch-profile.test.sh 125784
tests/fm-spawn-pool-base-freshen.test.sh 64426
tests/fm-spawn-session-name.test.sh 37643
tests/fm-spawn-ticket-warning.test.sh 11900
tests/fm-spawn-worktree-settle.test.sh 8452
tests/fm-startup-memory-budget.test.sh 17368
tests/fm-startup-network.test.sh 61921
tests/fm-stat-shadowing.test.sh 131
tests/fm-stow-cascade.test.sh 3224
tests/fm-subagent-pretool-check.test.sh 1108
tests/fm-supervision-events.test.sh 719
tests/fm-tangle-guard.test.sh 9662
tests/fm-task-delivery.test.sh 16591
tests/fm-task-inbox.test.sh 46400
tests/fm-teardown-endpoint-safety.test.sh 31896
tests/fm-teardown.test.sh 159037
tests/fm-test-fixture-cleanup.test.sh 1098
tests/fm-test-fixtures.test.sh 214
tests/fm-test-isolation-proof.test.sh 2757
tests/fm-tmux-agent-liveness.test.sh 2373
tests/fm-tool-update-check.test.sh 24443
tests/fm-trace-context-lib.test.sh 247
tests/fm-trace-context-spawn.test.sh 48101
tests/fm-turnend-guard.test.sh 42565
tests/fm-update.test.sh 24097
tests/fm-vendor-auth-probe.test.sh 46204
tests/fm-voice-relay.test.sh 34125
tests/fm-wake-daemon-lifecycle-e2e.test.sh 7986
tests/fm-wake-drain-open-decisions-cursor.test.sh 23200
tests/fm-wake-drain-open-decisions.test.sh 7089
tests/fm-wake-drain-outcome-backstop.test.sh 44753
tests/fm-wake-drain-unread-status.test.sh 46864
tests/fm-wake-drain.test.sh 2739
tests/fm-wake-queue.test.sh 79578
tests/fm-watch-arm.test.sh 64427
tests/fm-watch-checkpoint.test.sh 6101
tests/fm-watch-recovery-loop.test.sh 58819
tests/fm-watch-triage.test.sh 505780
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-tmux-lib.sh|bin/fm-operational-input.sh|bin/fm-tasks-axi-lib.sh|\
