...
tests/fm-ask-user-authority.test.sh 187
...
tests/fm-bearings-board-render.test.sh 4783
...
tests/fm-browser-reap.test.sh 12950
tests/fm-busy-adapter-wiring.test.sh 26861
...
tests/fm-claude-stop-autoarm-live-e2e.test.sh 99
...
tests/fm-composer-matrix-live-e2e.test.sh 120
tests/fm-control-relaunch.test.sh 53445
tests/fm-control.test.sh 53613
tests/fm-cswap.test.sh 1299
...
tests/fm-gate-refuse.test.sh 5320
...
tests/fm-harness-adapter-references.test.sh 101
...
tests/fm-muse-signals-live-e2e.test.sh 108
...
tests/fm-pi-branch-responsiveness-live-e2e.test.sh 13016
tests/fm-pi-primary-live-e2e.test.sh 93
...
tests/fm-procevent.test.sh 80399
...
tests/fm-quota-choose.test.sh 1488
...
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 228455
...
tests/fm-secondmate-reconcile.test.sh 97808
...
tests/fm-send-resolve-key.test.sh 32765
...
tests/fm-spawn-claude-persistence.test.sh 36399
tests/fm-spawn-dispatch-profile.test.sh 125784
tests/fm-spawn-pool-base-freshen.test.sh 63245
tests/fm-spawn-session-name.test.sh 21726
...
tests/fm-startup-network.test.sh 61443
...
tests/fm-teardown.test.sh 152243
...
tests/fm-vendor-auth-probe.test.sh 46029
tests/fm-voice-relay.test.sh 34125
tests/fm-wake-daemon-lifecycle-e2e.test.sh 7806
tests/fm-wake-drain-open-decisions-cursor.test.sh 21790
tests/fm-wake-drain-open-decisions.test.sh 7089
tests/fm-wake-drain-outcome-backstop.test.sh 43782
tests/fm-wake-drain-unread-status.test.sh 46864
tests/fm-wake-drain.test.sh 2379
tests/fm-wake-queue.test.sh 79206
