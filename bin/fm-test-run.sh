...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-afk-inject-e2e.test.sh 34873
tests/fm-afk-pi-herdr-return-e2e.test.sh 68
tests/fm-afk-return.test.sh 1242
tests/fm-agentsmd-ceiling.test.sh 237
tests/fm-agentsmd-skill-triggers.test.sh 45
tests/fm-ask-user-authority.test.sh 102
tests/fm-atlas-hook.test.sh 11972
tests/fm-backend-cmux-smoke.test.sh 24
tests/fm-backend-cmux.test.sh 3460
tests/fm-backend-herdr-focus-flash-e2e.test.sh 16
tests/fm-backend-orca.test.sh 18300
tests/fm-backend-tmux-smoke.test.sh 291
tests/fm-backend-zellij-smoke.test.sh 20
tests/fm-backend-zellij.test.sh 6278
tests/fm-backend.test.sh 18763
tests/fm-backlog-atomicity.test.sh 105660
tests/fm-backlog-handoff.test.sh 50591
tests/fm-bearings-board-render.test.sh 2247
...
tests/fm-calm-pi-extension.test.sh 231
tests/fm-classify-corr-token.test.sh 11459
tests/fm-classify-decision-key.test.sh 814
tests/fm-claude-stop-autoarm-live-e2e.test.sh 19
tests/fm-claude-stop-autoarm.test.sh 60720
...
tests/fm-fleet-sync.test.sh 32039
tests/fm-fleet-view.test.sh 235
tests/fm-gate-refuse.test.sh 4761
tests/fm-gitignore-config.test.sh 58
tests/fm-gotmp.test.sh 1229
tests/fm-grok-continuity-live-e2e.test.sh 19
tests/fm-grok-stop-live-e2e.test.sh 19
tests/fm-guard-stale-banner.test.sh 10814
tests/fm-harness-adapter-instructions-live-e2e.test.sh 18
tests/fm-harness-adapter-references.test.sh 52
tests/fm-harness-liveness-drift-live-e2e.test.sh 16
tests/fm-herdr-layout-lib.test.sh 178
...
tests/fm-muse-harness.test.sh 54740
tests/fm-muse-signals-live-e2e.test.sh 17
tests/fm-no-mistakes-required.test.sh 246
tests/fm-on.test.sh 10700
tests/fm-opencode-primary-live-e2e.test.sh 19
tests/fm-operational-input.test.sh 218
tests/fm-peek-remote.test.sh 886
tests/fm-pending-reply.test.sh 23455
tests/fm-pi-branch-extension.test.sh 21621
tests/fm-pi-branch-live-e2e.test.sh 19
tests/fm-pi-primary-live-e2e.test.sh 16
tests/fm-pi-watch-extension.test.sh 42468
tests/fm-ping-ack.test.sh 3948
tests/fm-pr-check-security.test.sh 154766
tests/fm-procevent-when.test.sh 14745
tests/fm-procevent.test.sh 55626
tests/fm-project-origin.test.sh 105
tests/fm-public-followup.test.sh 192137
tests/fm-quota-array-dispatch-live-e2e.test.sh 20
tests/fm-remote-backlog-handoff.test.sh 39998
tests/fm-remote-doctor.test.sh 3648
...
tests/fm-secondmate-harness.test.sh 134732
...
tests/fm-send-remote-delivery.test.sh 23626
tests/fm-send-resolve-key.test.sh 11883
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 49
tests/fm-send-secondmate-marker.test.sh 5743
tests/fm-session-lock-ancestry.test.sh 1146
tests/fm-session-start.test.sh 150551
tests/fm-sessionstart-hook-live-e2e.test.sh 19
tests/fm-sessionstart-instruction-refresh-live-e2e.test.sh 15
tests/fm-sessionstart-nudge.test.sh 64371
...
tests/fm-startup-network.test.sh 54242
tests/fm-stow-cascade.test.sh 2969
tests/fm-subagent-pretool-check.test.sh 948
tests/fm-supervision-events.test.sh 499
tests/fm-tangle-guard.test.sh 8932
tests/fm-task-delivery.test.sh 3869
tests/fm-task-inbox.test.sh 22733
tests/fm-teardown-endpoint-safety.test.sh 4488
tests/fm-teardown.test.sh 108905
tests/fm-test-fixture-cleanup.test.sh 719
tests/fm-test-fixtures.test.sh 144
tests/fm-test-isolation-proof.test.sh 2405
