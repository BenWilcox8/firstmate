...
# spawn-capable backend, currently herdr, zellij, or cmux, carries an
...
[ ! -f "$FM_BACKEND_LIB_DIR/fm-local-hooks.sh" ] || . "$FM_BACKEND_LIB_DIR/fm-local-hooks.sh" # fm_local_hook loader
